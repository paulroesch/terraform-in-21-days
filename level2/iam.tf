...
resource "aws_iam_role_policy_attachment" "main-AmazonEKSServicePolicy" {
...
resource "aws_iam_role_policy_attachment" "main-CloudWatchAgentServerPolicy" {
